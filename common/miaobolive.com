#!/usr/bin/perl -w
#DOMAIN : www.miaobolive.com
#AUTHOR : eotect <eotect@MyPlace>
#CREATED: 2016-08-14 02:41
#UPDATED: 2016-08-14 02:41
#TARGET : http://www.miaobolive.com/share/live?uid=5511333 :common
#URLRULE: 2.0
...
#http://www.miaobolive.com/m66379612
sub process_info {
	my ($url,$level,$rule) = @_;
	my $id;
	if($url =~ m/\/m(\d+)$/) {
	...
	my $info_url = 'http://www.miaobolive.com/MiaoBo/live/live_room_userinfo.aspx?useridx=' . $id;
