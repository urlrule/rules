#!/usr/bin/perl -w
#http://freeones.com
#Thu Dec 29 03:07:22 2011
use strict;


#<img width="78" height="120" title="" alt="" src="http://photos.freeones.com/z_babes/Zdenka_Podkapova_016/481_004_1280.jpg" class="middle bordered">
sub apply_rule {
 return (
       '#use quick parse'=>1,
       'data_exp'=>'<img[^>]*src\s*=\s*"([^"]+\/[^\/]+\/)([^\/]+\.jpg)"',
       'data_map'=>'$1 . "images/" . $2',
       'pass_exp'=>undef,
       'pass_map'=>undef,
       'pass_name_map'=>undef,
