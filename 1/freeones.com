...
sub apply_rule {
 return (
       ...
       'data_exp'=>undef,
       'data_map'=>undef,
#<a href="http://gallery.catalinacruz.com/gallhit.php?100044,2324,1,3,1" onclick="return track('bp', '885236', this.href);">Jezebelle Bond gets a Cock deep down her Throat</a>
       'pass_exp'=>'href="([^"]+)"[^>]*onclick="return track[^>]*>([^<]*)<',
