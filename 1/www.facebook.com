#!/usr/bin/perl -w
#http://www.facebook.com/Alina.fans#!/Alina.fans?v=photos
#Wed Oct  6 03:27:48 2010
use strict;
...
sub apply_rule {
 return (
       ...
       'data_exp'=>undef,
       'data_map'=>undef,
#       'pass_exp'=>'href="(/album\.php\?[^"]+)"\s*title="([^"]*)"',
	   'pass_exp'=>'href="https?://([^"]+)"[^>]*><strong>([^<]+)',
       #<strong><a href="([^"]*album\.php\?[^"]+)"[^>]*>([^<]*])<',
       'pass_map'=>'"https://" . $1',
       'pass_name_exp'=>'$2',
       'pages_exp'=>undef,
       'pages_map'=>undef,
